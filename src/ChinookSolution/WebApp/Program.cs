...
// GIVEN
// Supplied database connection due to the fact that we created this webapp to use Individual Accounts
...
// GIVEN
// Registers the supplied connection string with the IServiceCollection (.Services)
...
// ADDED
// Code the services logic to add our class library services to IServiceCollection
